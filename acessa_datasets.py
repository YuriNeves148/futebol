...
premier_2627_df = pd.read_csv(url.inglaterra_1)
premier_2627_df['Date'] = pd.to_datetime(premier_2627_df['Date'], format='%d/%m/%Y')
...
premier_2627_df['Temporada'] = "26/27"

laliga_2627_df = pd.read_csv(url.espanha_1)
laliga_2627_df['Date'] = pd.to_datetime(laliga_2627_df['Date'], format='%d/%m/%Y')
...
laliga_2627_df['Temporada'] = "26/27"

italia_2627_df = pd.read_csv(url.italia_1)
italia_2627_df['Date'] = pd.to_datetime(italia_2627_df['Date'], format='%d/%m/%Y')
...
italia_2627_df['Temporada'] = "26/27"

bundesliga_2627_df = pd.read_csv(url.bundesliga)
bundesliga_2627_df['Date'] = pd.to_datetime(bundesliga_2627_df['Date'], format='%d/%m/%Y')
...
bundesliga_2627_df['Temporada'] = "26/27"

ligue1_2627_df = pd.read_csv(url.franca_1)
ligue1_2627_df['Date'] = pd.to_datetime(ligue1_2627_df['Date'], format='%d/%m/%Y')
...
ligue1_2627_df['Temporada'] = "26/27"

holanda_2627_df = pd.read_csv(url.holanda_1)
holanda_2627_df['Date'] = pd.to_datetime(holanda_2627_df['Date'], format='%d/%m/%Y')
...
holanda_2627_df['Temporada'] = '26/27'

escocia_2627_df = pd.read_csv(url.escocia_1)
escocia_2627_df['Date'] = pd.to_datetime(escocia_2627_df['Date'], format='%d/%m/%Y')
...
portugal_2627_df['Temporada'] = "26/27"

argentina_df = pd.read_csv(url.argentina_1)
argentina_df['Date'] = pd.to_datetime(argentina_df['Date'], format='%d/%m/%Y')
argentina_df = argentina_df[['Date','Home', 'Season','Away','HG','AG','Res']]
argentina_df = argentina_df.rename(columns={'Home':'HomeTeam', 'Away':'AwayTeam', 'Season':'Temporada', 'HG': 'FTHG', 'AG': 'FTAG', 'Res': 'FTR'})
argentina_23_df = argentina_df.loc[argentina_df['Temporada'] == '2023'].copy()
argentina_24_df = argentina_df.loc[argentina_df['Temporada'] == '2024'].copy()
argentina_25_df = argentina_df.loc[argentina_df['Temporada'] == '2025'].copy()
argentina_26_df = argentina_df.loc[argentina_df['Temporada'] == '2026'].copy()

brasil_df = pd.read_csv(url.brasileirao)
brasil_df['Date'] = pd.to_datetime(brasil_df['Date'], format='%d/%m/%Y')
brasil_df = brasil_df[['Date','Home', 'Season','Away','HG','AG','Res']]
brasil_df = brasil_df.rename(columns={'Home':'HomeTeam', 'Away':'AwayTeam', 'Season':'Temporada', 'HG': 'FTHG', 'AG': 'FTAG', 'Res': 'FTR'})
brasil_23_df = brasil_df.loc[brasil_df['Temporada'] == 2023].copy()
brasil_24_df = brasil_df.loc[brasil_df['Temporada'] == 2024].copy()
brasil_25_df = brasil_df.loc[brasil_df['Temporada'] == 2025].copy()
brasil_26_df = brasil_df.loc[brasil_df['Temporada'] == 2026].copy()


premier_df = pd.concat([premier_2324_df, premier_2425_df, premier_2526_df, premier_2627_df])
laliga_df = pd.concat([laliga_2324_df, laliga_2425_df, laliga_2526_df, laliga_2627_df])
italia_df = pd.concat([italia_2324_df, italia_2425_df, italia_2526_df, italia_2627_df])
holanda_df = pd.concat([holanda_2324_df, holanda_2425_df, holanda_2526_df, holanda_2627_df]) 
bundesliga_df = pd.concat([bundesliga_2324_df, bundesliga_2425_df, bundesliga_2526_df, bundesliga_2627_df])
ligue1_df = pd.concat([ligue1_2324_df, ligue1_2425_df, ligue1_2526_df, ligue1_2627_df])
escocia_df = pd.concat([escocia_2324_df, escocia_2425_df, escocia_2526_df, escocia_2627_df])
portugal_df = pd.concat([portugal_2324_df, portugal_2425_df, portugal_2526_df, portugal_2627_df])
