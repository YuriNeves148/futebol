...
argentina_tudo = pd.read_csv(url.argentina_1)
...
brasil_tudo = pd.read_csv(url.brasileirao)
brasil_tudo['Date'] = pd.to_datetime(brasil_tudo['Date'], format='%d/%m/%Y')
brasil_tudo = brasil_tudo[['Date','Home', 'Season','Away','HG','AG','Res']]
brasil_23_df = brasil_tudo.loc[brasil_tudo['Season'] == 2023].copy()
brasil_24_df = brasil_tudo.loc[brasil_tudo['Season'] == 2024].copy()
brasil_25_df = brasil_tudo.loc[brasil_tudo['Season'] == 2025].copy()
brasil_26_df = brasil_tudo.loc[brasil_tudo['Season'] == 2026].copy()


premier_df = pd.concat([premier_2425_df, premier_2526_df, premier_2324_df, premier_2627_df])
laliga_df = pd.concat([laliga_2425_df, laliga_2526_df, laliga_2324_df, laliga_2627_df])
italia_df = pd.concat([italia_2425_df, italia_2526_df, italia_2324_df, italia_2627_df])
